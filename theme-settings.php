 ...
 */
function eyesbound_form_system_theme_settings_alter(array &$form, FormStateInterface $form_state) {
  ...
  // BrowserSync support.
  $form['options_settings']['eyesbound_browser_sync'] = [
    '#type' => 'fieldset',
    '#title' => t('BrowserSync Settings'),
  ];
  $form['options_settings']['eyesbound_browser_sync']['browser_sync']['#tree'] = TRUE;
  $form['options_settings']['eyesbound_browser_sync']['browser_sync']['enabled'] = [
    '#type' => 'checkbox',
  ...
  $form['options_settings']['eyesbound_browser_sync']['browser_sync']['host'] = [
    '#type' => 'textfield',
  ...
  $form['options_settings']['eyesbound_browser_sync']['browser_sync']['port'] = [
    '#type' => 'number',
    '#title' => t('Enable BrowserSync support for theme'),
  ...
  $form['options_settings']['eyesbound_ie'] = [
    '#type' => 'fieldset',
    '#title' => t('Internet Explorer Stylesheets'),
  ];
  $form['options_settings']['eyesbound_ie']['ie_enabled'] = [
    '#type' => 'checkbox',
  ...
  $form['options_settings']['eyesbound_ie']['ie_enabled_css'] = [
    '#type' => 'fieldset',
  ...
  $form['options_settings']['eyesbound_ie']['ie_enabled_css']['ie_enabled_versions'] = [
    '#type' => 'checkboxes',
    '#options' => [
